...
def _get_registrar_sync(hostname):
    ...
    try:
        ...
        # Handle potential list values for various fields
...
def _get_nameservers_sync(hostname):
    print("Iniciando búsqueda de NS para", hostname)
...
def _get_mx_records_sync(hostname):
    print("Iniciando búsqueda de MX para", hostname)
...
async def analizar_url(url):
    ...
    try:
        ...
        # --- Búsqueda de información extendida ---
